     ...
     caption: teks
        ...
        switch(command){
            ...
            case '?':{
                ...
                mentions(menu(ucapan, prefix, setting.emote, setting.botName, setting.ownerName, pushname, pendaftar, runtime(process.uptime()), isOwner, isPremium, sisalimit, limitCount, sisaGlimit, gcount, expiredPrem(), tanggal, jam), arr, true)
            })
            }
                break
            case prefix+'m': case prefix+'menu':{
                axios.get(`https://api-ramlan.herokuapp.com/api/ucapan?timeZone=Asia/Jakarta`)
                .then(async(ucapan) => {
                let sisalimit = getLimit(sender, limitCount, limit)
                let sisaGlimit = cekGLimit(sender, gcount, glimit)
                ...
                textImg(newMenu(ucapan, setting.ownerName, setting.botName, prefix, pendaftar, runtime(process.uptime()), pushname, isOwner, isPremium, sisalimit, limitCount, sisaGlimit, gcount, expiredPrem(), tanggal, jam, setting.emote))
            })
            }
                break
...
▒▒▒▒▒▒▒▒▒▒▒▐▒▒▒▒▌▒▒▒▒▒`, arr, true)
            ...
            case prefix+'sourcecode': case prefix+'sc': case prefix+'src':
                ...
                break
            case prefix+'lostfamz':
            case prefix+'lf':{
                let arr = [];
                for (let i of groupMembers){
                    arr.push(i.jid)
                }
                mentions(`*Yuk Join Grup 𝐋𝐨𝐬𝐭 𝐅𝐚𝐦𝐳 kak...*\n\n*https://chat.whatsapp.com/GX6nBkBk9pwFSvx6S2f8up*\n
*• About:*
_Didirikan untuk mencari kawan bukan lawan. dengan 9 pendiri tanpa_ *_KETUA_*.

*• Hope:*
_- Semoga bisa akrab sama semua admin dan member._
_- Semoga bisa jadi GC diskusi yg bermanfaat._

*• Rules:*
_- Jadilah_ *_Smart People_* _tanpa toxic yg berlebih._
_- Dilarang keras kirim_ *_Pornografi/20+_*.
_- Dilarang mengirimkan link grup lain tanpa seizin admin._ 
*(MELANGGAR = KICK)*`, arr, true)
                }
                break
            case 'r':
            case prefix+'r':
            case prefix+'runtime':{
                ...
                mentions(`*${runtime(process.uptime())}*`, arr, true)
                }
                break
            case prefix+'stats': 
            case prefix+'botstat':{
...
\`\`\`▢ Bio :\`\`\`\n${bio}`
            ...
            case prefix+'pinterest':
                ...
                if (args.length < 2) return reply(`Penggunaan ${command} text`)
                reply(mess.wait)
                axios.get(`https://api.justaqul.xyz/pinterest?q=anime&apikey=hJens6Ge26dlZShT`)
                .then(({data}) => {
...
//------------------< VVIBU >-------------------
            ...
            case prefix+'loli':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                reply(mess.wait)
                axios.get(`https://api.lolhuman.xyz/api/random/loli?apikey=6455179dfaf006d3ffd4a26a`)
						.then(({data}) => {
						sendFileFromUrl(from, data.link, 'Neh', msg)
						})
						limitAdd(sender, limit)
...
//------------------< Game >-------------------
            ...
            case prefix+'tebakgambar':{
                ...
                let anu = await axios.get(`https://hardianto-chan.herokuapp.com/api/kuis/tebakgambar?apikey=hardianto`)
                const petunjuk = anu.data.jawaban.replace(/P_nd_ng_n k_b_r]/gi, '_')
...
//------------------< G R U P >-------------------
            ...
            case prefix+'fitnah':
                ...
                var bot = gh.split("|")[2];
                xinz.sendMessage(from, `${bot}`, text, {quoted: { key: { fromMe: false, participant: `${mentioned}`, ...(from ? { remoteJid: from } : {}) }, message: { conversation: `${target}` }}})
            break
//------------------< Enable / Disable >-------------------
            ...
            case prefix+'mute':
                //if (!isGroup) return reply(mess.OnlyGrup)
                if (!isOwner) return reply(mess.GrupAdmin)
                //if (!isBotGroupAdmins) return reply(mess.BotAdmin)
            ...
            case prefix+'left':
                ...
                break
            case prefix+'gerindra':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                let son = fs.readFileSync('./media/music/gerindra.mp3')
            ...
            case prefix+'culik':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                let son = fs.readFileSync('./media/music/culik.mp3')
                xinz.sendMessage(from, son, audio, { quoted: msg })              
                limitAdd(sender, limit)
                }
                break
            case prefix+'anakanjing':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                let son = fs.readFileSync('./media/music/anakanjing.mp3')
                xinz.sendMessage(from, son, audio, { quoted: msg })              
                limitAdd(sender, limit)
                }
                break
            case prefix+'seeyou':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                let son = fs.readFileSync('./media/music/orangbaik.mp3')
                xinz.sendMessage(from, son, audio, { quoted: msg })              
                limitAdd(sender, limit)
                }
                break
            case prefix+'allah':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                let son = fs.readFileSync('./media/music/allah.mp3')
                xinz.sendMessage(from, son, audio, { quoted: msg })              
                limitAdd(sender, limit)
                }
                break
            case prefix+'sarimurni':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                let son = fs.readFileSync('./media/music/Sarimurni.mp3')
                xinz.sendMessage(from, son, audio, { quoted: msg })              
                limitAdd(sender, limit)
                }
                break
            case prefix+'sariroti':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                let son = fs.readFileSync('./media/music/sariroti.mp3')
                xinz.sendMessage(from, son, audio, { quoted: msg })              
                limitAdd(sender, limit)
                }
                break
            case prefix+'wadimor':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                let son = fs.readFileSync('./media/music/wadimor.mp3')
                xinz.sendMessage(from, son, audio, { quoted: msg })              
                limitAdd(sender, limit)
                }
                break
            case prefix+'yntkts':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                let son = fs.readFileSync('./media/music/yntkts.mp3')
                xinz.sendMessage(from, son, audio, { quoted: msg })              
                limitAdd(sender, limit)
                }
                break
            case prefix+'yoaimo':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                let son = fs.readFileSync('./media/music/yoaimo.mp3')
                xinz.sendMessage(from, son, audio, { quoted: msg })              
                limitAdd(sender, limit)
                }
                break
            case prefix+'ayojoget':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                let son = fs.readFileSync('./media/music/ayojoget.mp3')
                xinz.sendMessage(from, son, audio, { quoted: msg })              
                limitAdd(sender, limit)
                }
                break
            case prefix+'ara':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                let son = fs.readFileSync('./media/music/ara.mp3')
                xinz.sendMessage(from, son, audio, { quoted: msg })              
                limitAdd(sender, limit)
                }
                break
            case prefix+'ls':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                let son = fs.readFileSync('./media/music/ls.mp3')
                xinz.sendMessage(from, son, audio, { quoted: msg })              
                limitAdd(sender, limit)
                }
                break
            ...
            case prefix+'sound11':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                let son = fs.readFileSync('./media/music/sound11.mp3')
                xinz.sendMessage(from, son, audio, { quoted: msg })              
                limitAdd(sender, limit)
                }
                break
            case prefix+'pb':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                let son = fs.readFileSync('./media/music/pb.mp3')
                xinz.sendMessage(from, son, audio, { quoted: msg })              
                limitAdd(sender, limit)
                }
                break
